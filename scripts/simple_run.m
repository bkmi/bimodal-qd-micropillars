...
setup_params_nonDim_CnstCplRatio('save',0,'feed_ampli',0.1, 'feed_phase',pi,'alpha_par',0,'clear',0)
...
%     init_branch(funcs, ...
%     dde23_soln.y(:,end), param.feed_phase.index, 200, param, ...
%     'max_step',[param.feed_phase.index, (1.0)*pi/32], ...
