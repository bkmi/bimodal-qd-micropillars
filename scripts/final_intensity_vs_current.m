...
for i = 1:numPoints
    ...
    setup_params_nonDim_CnstCplRatio(...
        ...
        'feed_phase',0, ...
        'clear',0);
    dde23_soln = solver([1e-9;0;1e-9;0;0;0], [0,15], param, ...
        master_options, 'quiet',1);
...
%         'feed_phase',0, ...
%         'clear',0);
%     dde23_soln = solver([1e-9;0;1e-9;0;0;0], [0,10], param, ...
%         master_options, 'quiet', 1);
%     % 'dde23_options',ddeset('RelTol',10^-8,'OutputFcn', @odeplot)
% 
...
%         [10*(i-1),10*(i-1)+10], param, master_options, 'quiet', 1);
%     % 'dde23_options',ddeset('RelTol',10^-8,'OutputFcn', @odeplot)
%     
%     solnSweep(i).timeSeries = dde23_soln;
%     solnSweep(i).J = param.J.value;
...
solnSweep = sweeper(param.J.index, [Jmin, Jmax], param);
