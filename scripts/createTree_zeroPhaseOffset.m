...
feedAmpMat = [1, 0; 0, 1];
trunkdir = '/home/bkmiller/qd-micropillar-laser-project/data_bimodal-qd-micropillars/';

params = setup_params_nonDim_CnstCplRatio(...
    'save',1, ...
    'alpha_par',0, ...
    'feed_ampli',0.15, ...
    ...
    'clear',0, ...
    'datadir_specific',strcat(trunkdir,''));